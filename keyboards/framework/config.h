...
// Use 16 KiB logical storage over a 64 KiB wear-leveling region.
#define WEAR_LEVELING_LOGICAL_SIZE (4 * 4096)
#define WEAR_LEVELING_BACKING_SIZE (16 * 4096)

// The input module has 1 MiB flash. Keep the final 4 KiB sector free for
...
// Read the USB serial descriptor from the factory data sector.
