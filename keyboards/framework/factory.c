...
static void emulate_rgb_keycode_press(uint16_t target_keycode) {
...
static void handle_factory_command(uint8_t *data) {
...
static bool handle_hid(uint8_t *data, uint8_t length) {
    if (length < 2) {
        return false;
    }
